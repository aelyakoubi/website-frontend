...
const AboutUsPage = () => {
  ...
  return (
    <Box p={5}>
      <Heading mb={5} fontSize={70}>About Us</Heading>
      <Text mb={5}>
        ...
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus quisquam ex illo harum provident illum unde neque, nesciunt aliquam corrupti? Officiis harum est architecto placeat eum nulla et! Sunt, tenetur!

        lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus quisquam ex illo harum provident illum unde neque, nesciunt aliquam corrupti? Officiis harum est architecto placeat eum nulla et! Sunt, tenetur!
      </Text>
      <Heading size="md" mb={3} fontSize={70}>Meet Our Team</Heading>
      <VStack spacing={4}>
        {teamMembers.map((member, index) => (
          <HStack key={index} spacing={4} fontSize={30} >
            <Avatar name={member.name} src={member.image} />
            <VStack align="start">
              <Text fontWeight="bold" fontSize={40}>{member.name}</Text>
